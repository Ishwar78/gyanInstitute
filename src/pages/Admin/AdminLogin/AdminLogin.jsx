  ...
  return (
    <div className="admin-login">
      <div className="admin-login-panel">
        ...
        <p>Sign in to manage your Time website content.</p>
        <form onSubmit={submit}>
          <label>Email Address</label>
          <div className="login-input"><FiMail /><input type="email" placeholder="admin@gyanTime.com" defaultValue="admin@gyanTime.com" required /></div>
